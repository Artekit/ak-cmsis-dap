...
uint32_t DAP_ProcessCommand(uint8_t *request, uint8_t *response) {
  ...
  *response++ = *request;
  ...
  switch (*request++) {
    case ID_DAP_Info:
      DEBUG_STRING("ID_DAP_Info\r\n");
      num = DAP_Info(*request, response+1);
      *response = num;
      return (2 + num);
    case ID_DAP_HostStatus:
      DEBUG_STRING("ID_DAP_HostStatus\r\n");
      num = DAP_HostStatus(request, response);
      break;
    case ID_DAP_Connect:
      DEBUG_STRING("ID_DAP_Connect\r\n");
      num = DAP_Connect(request, response);
      break;
    case ID_DAP_Disconnect:
      DEBUG_STRING("ID_DAP_Disconnect\r\n");
      num = DAP_Disconnect(response);
      break;
    case ID_DAP_Delay:
      DEBUG_STRING("ID_DAP_Delay\r\n");
      num = DAP_Delay(request, response);
      break;
    case ID_DAP_ResetTarget:
      DEBUG_STRING("ID_DAP_ResetTarget\r\n");
      num = DAP_ResetTarget(response);
      break;

#if ((DAP_SWD != 0) || (DAP_JTAG != 0))
    case ID_DAP_SWJ_Pins:
      DEBUG_STRING("ID_DAP_SWJ_Pins\r\n");
      DEBUG_DUMP_INCOMING(request, 6);
      num = DAP_SWJ_Pins(request, response);
      break;
    case ID_DAP_SWJ_Clock:
      DEBUG_STRING("ID_DAP_SWJ_Clock\r\n");
      num = DAP_SWJ_Clock(request, response);
      break;
    case ID_DAP_SWJ_Sequence:
      DEBUG_STRING("ID_DAP_SWJ_Sequence\r\n");
      DEBUG_JTAG_SEQ(request);
    ...
    case ID_DAP_SWD_Configure:
      DEBUG_STRING("ID_DAP_SWD_Configure\r\n");
    ...
    case ID_DAP_JTAG_Sequence:
      DEBUG_STRING("ID_DAP_JTAG_Sequence\r\n");
      DEBUG_JTAG_SEQ(request);
      num = DAP_JTAG_Sequence(request, response);
      break;
    case ID_DAP_JTAG_Configure:
      DEBUG_STRING("ID_DAP_JTAG_Configure\r\n");
      num = DAP_JTAG_Configure(request, response);
      break;
    case ID_DAP_JTAG_IDCODE:
      DEBUG_STRING("ID_DAP_JTAG_IDCODE\r\n");
    ...
    case ID_DAP_TransferConfigure:
      DEBUG_STRING("ID_DAP_TransferConfigure\r\n");
      num = DAP_TransferConfigure(request, response);
      break;

    case ID_DAP_Transfer:
      DEBUG_STRING("ID_DAP_Transfer\r\n");
      switch (DAP_Data.debug_port) {
#if (DAP_SWD != 0)
        case DAP_PORT_SWD:
          DEBUG_STRING("ID_DAP_Transfer: DAP_PORT_SWD\r\n");
          num = DAP_SWD_Transfer (request, response);
          break;
#endif
#if (DAP_JTAG != 0)
        case DAP_PORT_JTAG:
          DEBUG_STRING("ID_DAP_Transfer: DAP_PORT_JTAG\r\n");
    ...
    case ID_DAP_TransferBlock:
      DEBUG_STRING("ID_DAP_TransferBlock\r\n");
      switch (DAP_Data.debug_port) {
#if (DAP_SWD != 0)
        case DAP_PORT_SWD:
          DEBUG_STRING("ID_DAP_TransferBlock: DAP_PORT_SWD\r\n");
          num = DAP_SWD_TransferBlock (request, response);
          break;
#endif
#if (DAP_JTAG != 0)
        case DAP_PORT_JTAG:
          DEBUG_STRING("ID_DAP_TransferBlock: DAP_PORT_JTAG\r\n");
    ...
    case ID_DAP_WriteABORT:
      DEBUG_STRING("ID_DAP_WriteABORT\r\n");
      switch (DAP_Data.debug_port) {
#if (DAP_SWD != 0)
        case DAP_PORT_SWD:
          DEBUG_STRING("ID_DAP_WriteABORT: DAP_PORT_SWD\r\n");
          num = DAP_SWD_Abort (request, response);
          break;
#endif
#if (DAP_JTAG != 0)
        case DAP_PORT_JTAG:
          DEBUG_STRING("ID_DAP_WriteABORT: DAP_PORT_JTAG\r\n");
