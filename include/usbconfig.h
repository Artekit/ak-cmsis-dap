...
#define DAP_INTERFACE_NO     0
#define DAP_INTR_IN_EP_ADDR  0x81    /* Bit 7 must be set.                 */
#define DAP_POLL_RATE        24      /* The bInterval reported with the    */
                                        /* interrupt IN endpoint descriptor.  */
#define DAP_IDLE_TIMER       0       /* Timer used to implement the idle-  */
